...
const Nav = (props) => {
    ...
    return (
        <>
            <nav
                className={`header-nav ${ menuVisible ? 'menu-visible' : ''
                    }`}
            >
                            ...
                            { headerMenuItems.edges.map((menu) => {
                                ...
                                return (
                                    <li
                                        ...
                                        className={`header-nav__menu-item ${ hasChildren
                                                ? 'menu-has-children'
                                                : ''
                                    ...
                                    >
                                        ...
                                        { hasChildren ? (
                                            <ul
                                                className={`header-nav__submenu ${ menuState[menu.node.databaseId].isOpen
                                                        ? 'child-menu-open'
                                                        : ''
                                                    }`}
                                            >
